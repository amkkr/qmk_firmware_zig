...
pub const QK_MAGIC_CAPS_LOCK_AS_CONTROL_OFF: Keycode = 0x7003;
pub const QK_MAGIC_CAPS_LOCK_AS_CONTROL_ON: Keycode = 0x7004;
pub const QK_MAGIC_SWAP_LALT_LGUI: Keycode = 0x7005;
pub const QK_MAGIC_UNSWAP_LALT_LGUI: Keycode = 0x7006;
pub const QK_MAGIC_SWAP_RALT_RGUI: Keycode = 0x7007;
pub const QK_MAGIC_UNSWAP_RALT_RGUI: Keycode = 0x7008;
pub const QK_MAGIC_GUI_ON: Keycode = 0x7009;
pub const QK_MAGIC_GUI_OFF: Keycode = 0x700A;
pub const QK_MAGIC_TOGGLE_GUI: Keycode = 0x700B;
pub const QK_MAGIC_SWAP_GRAVE_ESC: Keycode = 0x700C;
pub const QK_MAGIC_UNSWAP_GRAVE_ESC: Keycode = 0x700D;
pub const QK_MAGIC_SWAP_BACKSLASH_BACKSPACE: Keycode = 0x700E;
pub const QK_MAGIC_UNSWAP_BACKSLASH_BACKSPACE: Keycode = 0x700F;
pub const QK_MAGIC_TOGGLE_BACKSLASH_BACKSPACE: Keycode = 0x7010;
pub const QK_MAGIC_NKRO_ON: Keycode = 0x7011;
pub const QK_MAGIC_NKRO_OFF: Keycode = 0x7012;
pub const QK_MAGIC_TOGGLE_NKRO: Keycode = 0x7013;
pub const QK_MAGIC_SWAP_ALT_GUI: Keycode = 0x7014;
pub const QK_MAGIC_UNSWAP_ALT_GUI: Keycode = 0x7015;
pub const QK_MAGIC_TOGGLE_ALT_GUI: Keycode = 0x7016;
pub const QK_MAGIC_SWAP_LCTL_LGUI: Keycode = 0x7017;
pub const QK_MAGIC_UNSWAP_LCTL_LGUI: Keycode = 0x7018;
pub const QK_MAGIC_SWAP_RCTL_RGUI: Keycode = 0x7019;
pub const QK_MAGIC_UNSWAP_RCTL_RGUI: Keycode = 0x701A;
pub const QK_MAGIC_SWAP_CTL_GUI: Keycode = 0x701B;
pub const QK_MAGIC_UNSWAP_CTL_GUI: Keycode = 0x701C;
pub const QK_MAGIC_TOGGLE_CTL_GUI: Keycode = 0x701D;
pub const QK_MAGIC_EE_HANDS_LEFT: Keycode = 0x701E;
pub const QK_MAGIC_EE_HANDS_RIGHT: Keycode = 0x701F;
...
pub const CL_NORM: Keycode = QK_MAGIC_UNSWAP_CONTROL_CAPS_LOCK;
pub const CL_TOGG: Keycode = QK_MAGIC_TOGGLE_CONTROL_CAPS_LOCK;
pub const CL_CAPS: Keycode = QK_MAGIC_CAPS_LOCK_AS_CONTROL_OFF;
pub const CL_CTRL: Keycode = QK_MAGIC_CAPS_LOCK_AS_CONTROL_ON;
pub const AG_LSWP: Keycode = QK_MAGIC_SWAP_LALT_LGUI;
pub const AG_LNRM: Keycode = QK_MAGIC_UNSWAP_LALT_LGUI;
pub const AG_RSWP: Keycode = QK_MAGIC_SWAP_RALT_RGUI;
pub const AG_RNRM: Keycode = QK_MAGIC_UNSWAP_RALT_RGUI;
pub const GU_ON: Keycode = QK_MAGIC_GUI_ON;
pub const GU_OFF: Keycode = QK_MAGIC_GUI_OFF;
pub const GU_TOGG: Keycode = QK_MAGIC_TOGGLE_GUI;
pub const GE_SWAP: Keycode = QK_MAGIC_SWAP_GRAVE_ESC;
pub const GE_NORM: Keycode = QK_MAGIC_UNSWAP_GRAVE_ESC;
pub const BS_SWAP: Keycode = QK_MAGIC_SWAP_BACKSLASH_BACKSPACE;
pub const BS_NORM: Keycode = QK_MAGIC_UNSWAP_BACKSLASH_BACKSPACE;
pub const BS_TOGG: Keycode = QK_MAGIC_TOGGLE_BACKSLASH_BACKSPACE;
pub const NK_ON: Keycode = QK_MAGIC_NKRO_ON;
pub const NK_OFF: Keycode = QK_MAGIC_NKRO_OFF;
pub const NK_TOGG: Keycode = QK_MAGIC_TOGGLE_NKRO;
pub const AG_SWAP: Keycode = QK_MAGIC_SWAP_ALT_GUI;
pub const AG_NORM: Keycode = QK_MAGIC_UNSWAP_ALT_GUI;
pub const AG_TOGG: Keycode = QK_MAGIC_TOGGLE_ALT_GUI;
pub const CG_LSWP: Keycode = QK_MAGIC_SWAP_LCTL_LGUI;
pub const CG_LNRM: Keycode = QK_MAGIC_UNSWAP_LCTL_LGUI;
pub const CG_RSWP: Keycode = QK_MAGIC_SWAP_RCTL_RGUI;
pub const CG_RNRM: Keycode = QK_MAGIC_UNSWAP_RCTL_RGUI;
pub const CG_SWAP: Keycode = QK_MAGIC_SWAP_CTL_GUI;
pub const CG_NORM: Keycode = QK_MAGIC_UNSWAP_CTL_GUI;
pub const CG_TOGG: Keycode = QK_MAGIC_TOGGLE_CTL_GUI;
pub const EH_LEFT: Keycode = QK_MAGIC_EE_HANDS_LEFT;
pub const EH_RGHT: Keycode = QK_MAGIC_EE_HANDS_RIGHT;
pub const EC_SWAP: Keycode = QK_MAGIC_SWAP_ESCAPE_CAPS_LOCK;
